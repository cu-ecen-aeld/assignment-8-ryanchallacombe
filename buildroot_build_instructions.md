...
# assignment 8 troubleshooting 2026 05 22
building/running qemu and testing sockettest.sh from the a5 directory all works fine

when i try to build from a8 dir I get this:
ryan@Ubuntu22:~/projects/assignment-8-ryanchallacombe$ ./build.sh 
...
make: Entering directory '/home/ryan/projects/assignment-8-ryanchallacombe/buildroot'
/usr/bin/make -j1  O=/home/ryan/projects/assignment-8-ryanchallacombe/buildroot/output HOSTCC="/usr/bin/gcc" HOSTCXX="/usr/bin/g++" syncconfig
>>> host-gmp 6.3.0 Building
GIT_DIR=. PATH="/home/ryan/projects/assignment-8-ryanchallacombe/buildroot/output/host/bin:/home/ryan/projects/assignment-8-ryanchallacombe/buildroot/output/host/sbin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin:/snap/bin:/home/ryan/projects/aarch64_toolchain_install_dir/install/arm-gnu-toolchain-13.3.rel1-x86_64-aarch64-none-linux-gnu/bin" PKG_CONFIG="/home/ryan/projects/assignment-8-ryanchallacombe/buildroot/output/host/bin/pkg-config" PKG_CONFIG_SYSROOT_DIR="/" PKG_CONFIG_ALLOW_SYSTEM_CFLAGS=1 PKG_CONFIG_ALLOW_SYSTEM_LIBS=1 PKG_CONFIG_LIBDIR="/home/ryan/projects/assignment-8-ryanchallacombe/buildroot/output/host/lib/pkgconfig:/home/ryan/projects/assignment-8-ryanchallacombe/buildroot/output/host/share/pkgconfig"  /usr/bin/make -j7  -C /home/ryan/projects/assignment-8-ryanchallacombe/buildroot/output/build/host-gmp-6.3.0/
make[2]: *** No targets.  Stop.
make[1]: *** [package/pkg-generic.mk:283: /home/ryan/projects/assignment-8-ryanchallacombe/buildroot/output/build/host-gmp-6.3.0/.stamp_built] Error 2
make: *** [Makefile:82: _all] Error 2
make: Leaving directory '/home/ryan/projects/assignment-8-ryanchallacombe/buildroot'

The base_external/configs/aesd_qemu_defconfig files in a8 and a5 are identical
ryan@Ubuntu22:~/projects/assignment-8-ryanchallacombe$ cat base_external/configs/aesd_qemu_defconfig 
BR2_aarch64=y
BR2_PACKAGE_HOST_LINUX_HEADERS_CUSTOM_6_1=y
BR2_TARGET_GENERIC_ROOT_PASSWD="root"
BR2_SYSTEM_DHCP="eth0"
...
So I decided to run clean.sh:
ryan@Ubuntu22:~/projects/assignment-8-ryanchallacombe$ ./clean.sh 
Running make clean from working directory /home/ryan/projects/assignment-8-ryanchallacombe/buildroot
rm -rf /home/ryan/projects/assignment-8-ryanchallacombe/buildroot/output/target /home/ryan/projects/assignment-8-ryanchallacombe/buildroot/output/images /home/ryan/projects/assignment-8-ryanchallacombe/buildroot/output/host  \
	/home/ryan/projects/assignment-8-ryanchallacombe/buildroot/output/build /home/ryan/projects/assignment-8-ryanchallacombe/buildroot/output/staging \
	/home/ryan/projects/assignment-8-ryanchallacombe/buildroot/output/legal-info /home/ryan/projects/assignment-8-ryanchallacombe/buildroot/output/graphs /home/ryan/projects/assignment-8-ryanchallacombe/buildroot/output/per-package /home/ryan/projects/assignment-8-ryanchallacombe/buildroot/output/pkg-stats.*

After this, running cat base_external/configs/aesd_qemu_defconfig gives the same results as prior, so the clean must not impact this. 
ryan@Ubuntu22:~/projects/assignment-8-ryanchallacombe$ cat base_external/configs/aesd_qemu_defconfig 
BR2_aarch64=y
BR2_PACKAGE_HOST_LINUX_HEADERS_CUSTOM_6_1=y
BR2_TARGET_GENERIC_ROOT_PASSWD="root"
...
- I had to run these again:
- run `make aesdchar-module-rebuild`
- run `./build.sh`

# keep having issues with aesdchar module not starting up when running actions
# suspect it be be the following in the aesdchar-module package Config.in file
config BR2_PACKAGE_AESDCHAR-MODULE
	bool "aesdchar-module"
	help
	  assignment 8 with aesdchar module

Note the AESDCHAR-MODULE instead of AESDCHAR_MODULE as specified in the aesdchar-module.mk file.
Updated the file to AESDCHAR_MODULE, saved. 

- run save-config.sh
	now AESDCHAR-MODULE is missing
- run make menuconfig
	Now aesdchar-module shows as new. select it and save

- run ./save-config.sh
- now run this again. Note the update: BR2_PACKAGE_AESDCHAR_MODULE=y
ryan@Ubuntu22:~/projects/assignment-8-ryanchallacombe$ cat base_external/configs/aesd_qemu_defconfig
BR2_aarch64=y
BR2_PACKAGE_HOST_LINUX_HEADERS_CUSTOM_6_1=y
BR2_TARGET_GENERIC_ROOT_PASSWD="root"
...
BR2_PACKAGE_HOST_QEMU_SYSTEM_MODE=y
BR2_PACKAGE_AESD_ASSIGNMENTS=y
BR2_PACKAGE_AESDCHAR_MODULE=y
BR2_PACKAGE_LDD=y

- run make aesdchar-module-rebuild
- run ./build.sh

This worked! Lesson: be careful naming modules!
